...
Patch3: 0001-Use-the-correct-name-for-the-libsystemd-pkg-config-n.patch
...
export CFLAGS="-O2 -g"
unset LDFLAGS
%reconfigure --disable-static --with-int10=x86emu --enable-config-udev --enable-config-udev-kms  --enable-dri2 --enable-dri --enable-dbe --enable-record --disable-systemd-logind
